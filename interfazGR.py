...
class bienvenida3:
    def __init__(self):
        ...
        self.win3.title('..::Gramatica::..') # Titulo de la ventana
    ...
    def Ventana2(self):
        Label(self.win3, text="...:::...Creación de Gramaticas...:::...", font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=52).place(x=200, y=20)
        Label(self.win3, text="Ingrese el nombre de la Gramaticas :", font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=52).place(x=90, y=50)
        Label(self.win3, text="Ingrese los No terminales separados por una coma: ", font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=52).place(x=90, y=80)
        Label(self.win3, text="Ingrese los Terminales separados por una coma: ", font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=52).place(x=90, y=110)
        Label(self.win3, text="Ingrese el Inicio de la gramatica: ", font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=52).place(x=90, y=140)
        Label(self.win3, text="Ingrese los estados de aceptacion de la gramatica separados por una coma: ", font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=52).place(x=90, y=170)
        Label(self.win3, text="Ingrese las producciones de la gramatica separados por una coma: ", font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=52).place(x=90, y=200)
