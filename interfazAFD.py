...
class bienvenida2:
    ...
    def Ventana2(self):
        ...
        Entry(self.win2, textvariable=self.content1,font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=20).place(x=720, y=50)
        ...
        Button(self.frame2, text="Cargar Archivo",command=helpafd, font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=15).place(x=420, y=320)
    ...
    # creacion de transiciones por separado
        ...
        for automata in lista_automatas:
            ...
            Label(self.win2, text=txt6, font=('Times New Roman',15), fg='#000000', bg='#ff6f00', width=50).place(x=75, y=620)
